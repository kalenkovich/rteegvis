from nfb.helpers.dc_blocker import DCBlocker
from nfb.postprocessing.utils import get_info
from nfb.signal_processing.filters import ButterFilter, FilterSequence, FilterStack, InstantaneousVarianceFilter
from nfb.signal_processing.decompositions import SpatialDecompositionPool
from sklearn.neural_network import MLPClassifier
from sklearn.ensemble import RandomForestClassifier
import numpy as np

from nfb.signal_processing.helpers import get_outliers_mask
from nfb.signals._bci_dev.bcimodel_draft import BCIModel
from nfb.signals.bci import BCISignal
...
if __name__ == '__main__':
    ...
    #file = r'C:\Users\Nikolai\PycharmProjects\nfb\nfb\results\BCI_Test_2_1_06-22_17-01-07\experiment_data.h5'
